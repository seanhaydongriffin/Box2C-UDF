...
Global $girder_shape_index = _Box2C_b2PolygonShape_ArrayAdd_SFML($girder_shape_vertice, @ScriptDir & "\girder.png")
...
Global $girder1_bodydef_index = _Box2C_b2BodyDef_ArrayAdd(0, 0, 2, degrees_to_radians(-5))
Global $girder2_bodydef_index = _Box2C_b2BodyDef_ArrayAdd(0, 2, -1, degrees_to_radians(5))
Global $girder3_bodydef_index = _Box2C_b2BodyDef_ArrayAdd(0, 0, -4, degrees_to_radians(-5))
...
Local $girder1_body_index = _Box2C_b2Body_ArrayAdd_SFML($girder1_bodydef_index, $girder_shape_index, 0, 0, 0, $girder_shape_index, 0, 2)
Local $girder2_body_index = _Box2C_b2Body_ArrayAdd_SFML($girder2_bodydef_index, $girder_shape_index, 0, 0, 0, $girder_shape_index, 2, -1)
Local $girder3_body_index = _Box2C_b2Body_ArrayAdd_SFML($girder3_bodydef_index, $girder_shape_index, 0, 0, 0, $girder_shape_index, 0, -4)
...
Global $window_ptr = _CSFML_sfRenderWindow_create($video_mode, "Box2D Forces Test for the SFML Engine", $CSFML_sfWindowStyle_sfResize + $CSFML_sfWindowStyle_sfClose, Null)
